...
const DynamicGlobeViewport = dynamic(
    async () => {
        // Ensure you have added the component via CLI or manual copy: @/components/ui/globe
        const { World } = await import("@/components/ui/globe");

        return function GlobeViewport() {
            // Configuration values mapped according to Aceternity's GitHub Globe spec
            const globeConfig = {
                pointSize: 4,
                globeColor: "#070708",
                showAtmosphere: true,
                atmosphereColor: "#a855f7",           // Changed from #3b82f6 (blue) to #a855f7 (purple)
                atmosphereAltitude: 0.1,
                emissive: "#060608",
                emissiveIntensity: 0.1,
                shininess: 0.9,
                polygonColor: "rgba(168, 85, 247, 0.4)", // Changed to purple with opacity
                ambientLight: "#a855f7",              // Changed from #38bdf8 (light blue) to purple
                directionalLeftLight: "#ffffff",
                directionalTopLight: "#ffffff",
                pointLight: "#a855f7",                // Changed to purple
                arcTime: 2000,
                arcLength: 0.9,
                rings: 1,
                maxRings: 3,
            ...
            // Mock arc tracking points (e.g., Global edge distribution nodes)
            const sampleArcs = [
                {
                    order: 1,
                    startLat: 24.8607,
            ...
            return (
                <div className="w-full h-full relative flex items-center justify-center">
                    {/* Natural depth backdrop radial glow */}
